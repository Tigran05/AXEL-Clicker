...
import AXEL1 from '@/assets/AXEL1.png'
import AXEL2 from '@/assets/AXEL2.png'
import AXEL3 from '@/assets/AXEL3.png'
import AXEL4 from '@/assets/AXEL4.png'

const img = ref(null)
const imgSrc = computed(() => {
  if (store.score > 32768000) {
    return AXEL4 } else if (store.score > 1024000) {
      return AXEL3 } else if (store.score > 32000) {
        return AXEL2 } else {
        return AXEL1
        }
        })
